                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                        ...
                        <div class="card custom-card  rectangle2">
                            <div class="card-body p-sm-5 p-3  rectangle3">
                                ...
                                <p class="mb-4 text-muted op-7 fw-normal text-center">Welcome &amp; Join us by creating
                                    a free account !</p>
                                <div class="row gy-3">
                                    <div class="col-xl-12">
                                        <label for="signup-firstname" class="form-label text-default">Full
                                            Name</label>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <input type="email" class="form-control form-control-lg"
                                            id="signup-lastname" placeholder="emali">
                                    </div>
                                    <div class="col-xl-12 d-grid mt-2">
                                        <button type="button" class="btn btn-lg btn-primary mt-4">Create
                                            Account</button>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <p class="fs-12 text-muted mt-3">Already have an account? <a
                                            href="sign-in-basic.html" class="text-primary">Sign In</a></p>
                                </div>
                                ...
                                <div class="btn-list text-center">
                                    <button aria-label="button" type="button"
                                        class="btn btn-icon btn-light btn-wave waves-effect waves-light">
