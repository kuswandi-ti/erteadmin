...
@section('page_content')
    ...
    <div class="landing-banner" id="home">
        <section class="section">
            <div class="container main-banner-container">
                <img src="{{ url(config('common.path_template_web') . 'images/media/landing/5.png') }}" alt="img"
                    class="banner-png">
                <img src="{{ url(config('common.path_template_web') . 'images/media/landing/3.png') }}" alt="img"
                    class="banner-png1">
                <img src="{{ url(config('common.path_template_web') . 'images/media/landing/4.png') }}" alt="img"
                    class="banner-png2">
                <img src="{{ url(config('common.path_template_web') . 'images/media/landing/6.png') }}" alt="img"
                    class="banner-png3">
                <div class="row justify-content-center">
                    <div class="col-xxl-9 col-xl-8 col-lg-12 col-md-12">
                        <div class="py-lg-5 text-center">
                            <p class="landing-banner-heading text-fixed-white mb-1">Best theme ends here with <span
                                    class="">Velvet !</span></p>
                            <div class="fs-16 mb-4 text-fixed-white op-8 px-4">Velvet - Now you can use this admin template
                                to design stunning, good and well well-structured dashboards that will wow your target
                                viewers or users to no end.</div>
                            <a href="index.html" class="m-1 btn btn-lg btn-success" target="_blank"> Get Started <i
                                    class="ri-arrow-right-line ms-2 align-middle"></i> </a>
                            <a href="index.html" class="m-1 btn btn-lg btn-light" target="_blank"> View Demos <i
                                    class="ri-eye-line ms-2 align-middle"></i> </a>
                        </div>
                    </div>
                </div>
        </section>
    ...
    <section class="section section-background section-style " id="features">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">Most advanced features in Velvet along with only javascript
                        dependability and zeo jquery boosts the performance of your project.</p>
                </div>
            </div>
                    ...
                    <div class="card custom-card card-style-angle border">
                        <div class="card-body rounded m-2  text-center">
                            <div class="features-icon m-auto mb-2 bg-primary-transparent">
                                <svg class="svg-primary shadow-lg" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <a class="fs-12 mx-1 text-primary" href="javascript:void(0);">Read More<i
                    ...
                    <div class="card custom-card border card-style-angle ">
                        <div class="card-body text-center rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-secondary-transparent">
                                <svg class="svg-secondary shadow-lg" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="card custom-card card-style-angle   border">
                        <div class="card-body text-center rounded m-2">
                            <div class="features-icon mb-2 m-auto  bg-warning-transparent">
                                <svg class="svg-warning shadow-lg" xmlns="http://www.w3.org/2000/svg"
                                    enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                    <path
                    ...
                    <div class="card custom-card card-style-angle border">
                        <div class="card-body text-center  rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-info-transparent">
                                <svg class="svg-info shadow-lg" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                    viewBox="0 0 24 24">
                                    <path opacity=".3"
                                    ...
                                    <path opacity=".3" d="M6.5,11A4.5,4.5,0,1,1,11,6.5,4.50491,4.50491,0,0,1,6.5,11Z" />
                                </svg>
                            </div>
                            <h6 class="fw-semibold mx-1">
                                6 types of Icons
                    ...
                    <div class="card custom-card  card-style-angle border">
                        <div class="card-body text-center rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-pink-transparent">
                                <svg class="svg-pink shadow-lg" xmlns="http://www.w3.org/2000/svg"
                                    enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                                    <path opacity=".3"
                    ...
                    <div class="card custom-card  card-style-angle  border">
                        <div class="card-body text-center rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-purple-transparent">
                                <svg class="svg-purple shadow-lg" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                    viewBox="0 0 24 24">
                    ...
                    <div class="card custom-card card-style-angle border">
                        <div class="card-body text-center  rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-success-transparent">
                                <svg class="svg-success shadow-lg" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24">
                                    <path opacity=".3"
                            ...
                            <p class="text-muted mb-2 mx-1">
                                The documentation provides clear-cut material for the Velvet admin template user can
                                understand .
                            </p>
                            <a class="fs-12 mx-1 text-primary" href="javascript:void(0);">Read More<i
                                    class="ri-arrow-right-s-line align-middle"></i></a>
                    ...
                    <div class="card custom-card card-style-angle  border">
                        <div class="card-body  text-center rounded m-2">
                            <div class="features-icon mb-2 m-auto bg-danger-transparent">
                                <svg class="svg-danger shadow-lg" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                                    viewBox="0 0 24 24">
                                    <path opacity=".3"
    ...
    <section class="section" id="about">
        <img src="{{ url(config('common.path_template_web') . 'images/media/landing/4.png') }}" alt="img"
            class="banner-png2 op-1">
        <img src="{{ url(config('common.path_template_web') . 'images/media/landing/7.png') }}" alt="img"
            class="banner-png4">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">Velvet comes with multiple customization options that are
                        very easy to implement,some of customizable options are shown below.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-5 customize-image">
                    <img src="{{ url(config('common.path_template_web') . 'images/media/landing/1.png') }}" alt=""
                        class="custmize-img">
                </div>
                <div class="col-lg-7 text-start">
                    <p class="h4 mb-0"> Get to Know what we do?</p>
                    <p class="mb-4 sub-text">Explore our diverse range of services and gain insight into our areas of
                        specialization.</p>
                    <ul class="list-unstyled fw-500 mb-4">
                        <li class="list-item mb-2">
                            <div class="d-flex align-items-start">
                                <span class="me-1 text-primary op-8"><i
                                        class="bx bx-radio-circle-marked fs-20"></i></span>
                                <div>
                                    <h6 class="fs-15">Creative Design</h6>
                                    <p class="op-8">Sed ut persp iciatis unde omnis iste natus er ror sit eaque ipsa quae
                        ...
                        <li class="list-item mb-2">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="op-8 mb-0">At vero eos et accusamus et iusto odio dignissimos ducimus qui
                                        blanditiis praesentium volup tatum delen iti, atque corrupti quos dolores</p>
                                </div>
                            </div>
                        </li>
                    </ul>
    ...
    <section class="section landing-Features" id="statistics">
        <div class="container text-center position-relative  text-fixed-white">
            <p class="fs-12 fw-semibold text-primary mb-1  text-fixed-white"><span
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="op-7 fs-15 mb-5 fw-normal  text-fixed-white">We are proud to have top class clients and
    ...
    <section class="section landing-testimonials section-background section-style " id="clients">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">Success is best when it shared,our team consists of highly
                        qulified employees that works hard to raise company standards.</p>
                </div>
            </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="card custom-card text-center team-card border">
                            <div class="card-body">
                                <span class="avatar avatar-xxl avatar-rounded mb-3 team-avatar">
                                    <img src="{{ url(config('common.path_template_web') . 'images/faces/4.jpg') }}"
                                        alt="">
                                </span>
                                <p class="fw-semibold fs-15 mb-0 text-default mt-4">Samantha Taylor</p>
                                <span class="text-primary fs-12">Founder &amp; CEO</span>
                                <p class="text-muted px-1 mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                </p>
                                <div class="mt-3">
                                    <div class="btn-list">
                    ...
                    <div class="swiper-slide">
                        <div class="card custom-card text-center team-card border">
                            <div class="card-body">
                                <span class="avatar avatar-xxl avatar-rounded mb-3 team-avatar">
                                    <img src="{{ url(config('common.path_template_web') . 'images/faces/15.jpg') }}"
                                        alt="">
                                </span>
    ...
    <section class="section" id="our-mission">
        ...
        <div class="container text-center">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">We assemble an experienced interdisciplinary team to make
                        your vision real. We turn your ideas into great digital products.</p>
                </div>
            </div>
    ...
    <section class="section section-background section-style" id="pricing">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-3 fw-normal">Our plans are most affordable and are mainly placed by
                        focussing every category in the sector even basic plan helps better.</p>
                </div>
            ...
            <div class="col-xl-12">
                <div class="tab-content" id="myTabContent1">
                                ...
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body p-0">
                                        <div class="p-4">
                                            ...
                                            <div class="fs-25 fw-bold mb-1">$0<sub class="text-muted fw-semibold fs-11">/
                                                    Per Month</sub></div>
                                            <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing
                                                elit. Iure quos debitis aliquam .</div>
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li class="d-grid">
                                                    <button type="button" aria-label="button"
                                                        class="btn btn-light btn-wave waves-effect waves-light">Choose
                                                        Plan</button>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body p-0">
                                        <div class="p-4">
                                            ...
                                            <div class="fs-25 fw-bold mb-1">$149<sub
                                                    class="text-muted fw-semibold fs-11">/ Per Month</sub></div>
                                            <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing
                                                elit. Iure quos debitis aliquam .</div>
                                            <div class="fs-12 mb-3"><u>Billed Monthly</u></div>
                                            <ul class="list-unstyled mb-0">
                                    ...
                                    <div class="d-flex flex-column p-0">
                                        <div class="card-body p-0">
                                            <div class="p-4">
                                                ...
                                                <div class="fs-25 fw-bold mb-1">$1,299<sub
                                                        class="text-muted fw-semibold fs-11">/ Per Month</sub></div>
                                                <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit. Iure quos debitis aliquam .</div>
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    ...
                                                    <li class="d-flex align-items-center mb-3">
                                                        ...
                                                        <span>
                                                            <strong class="me-1 d-inline-block">20 GB</strong>Hard disk
                                                            storage
                                                        </span>
                                                    </li>
                                                    <li class="d-flex align-items-center mb-3">
                                                        ...
                                                        <span>
                                                            <strong class="me-1 d-inline-block">3 Years</strong>Email
                                                            support
                                                        </span>
                                                    </li>
                                                    <li class="d-flex align-items-center mb-3">
                                                    ...
                                                    <li class="d-grid">
                                                        <button type="button" aria-label="button"
                                                            class="btn btn-primary btn-wave waves-effect waves-light">Choose
                                                            Plan</button>
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div class="tab-pane p-0 border-0" id="pricing-yearly1-pane" role="tabpanel"
                        aria-labelledby="pricing-yearly1" tabindex="0">
                        <div class="row justify-content-center">
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body p-0">
                                ...
                                <div class="card custom-card overflow-hidden">
                                    <div class="card-body p-0">
                                        <div class="p-4">
                                            ...
                                            <div class="fs-25 fw-bold mb-1">$10,49<sub
                                                    class="text-muted fw-semibold fs-11">/ Per Month</sub></div>
                                            <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur adipisicing
                                                elit. Iure quos debitis aliquam .</div>
                                            <div class="fs-12 mb-3"><u>Billed Monthly</u></div>
                                    ...
                                    <div class=" d-flex flex-column p-0">
                                        <div class="card-body p-0">
                                            <div class="p-4">
                                                ...
                                                <div class="fs-25 fw-bold mb-1">$50,299<sub
                                                        class="text-muted fw-semibold fs-11">/ Per Month</sub></div>
                                                <div class="mb-1 text-muted">Lorem ipsum dolor sit amet consectetur
                                                    adipisicing elit. Iure quos debitis aliquam .</div>
                                                <div class="fs-12 mb-3 text-primary"><u>Billed Monthly</u></div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-12  text-start">
                    ...
                    <p class=" fs-15 fw-normal text-fixed-white op-7">We develop modern concepts to design and develop the
                        interface design, web development to deliver them with eye-catching innovative ideas. We believe in
                        effective, efficient and timely solutions for various types of businesses. Our team develops a
                    ...
                    <span class="text-center d-flex">
                        <input type="email" class="form-control wd-200 me-2" id="contact-address-email"
                            placeholder="Enter Email Id">
                        <button type="button" aria-label="button" class="text-center btn btn-wave btn-secondary">Notify
                            me</button>
                    </span>
                </div>
            </div>
    ...
    <section class="section  section-background section-style" id="faq">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">We have shared some of the most frequently asked questions
                        to help you out.</p>
                </div>
            </div>
            <div class="row text-start">
    ...
    <section class="section" id="testimonials">
        ...
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <p class="text-muted fs-15 mb-5 fw-normal">Some of the reviews our clients gave which brings
                        ...
                        <div class="card custom-card border">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <div class="mb-3 ps-2">
                                        <span class="text-muted"><i class="ri-double-quotes-l fs-15"></i> Lorem ipsum
                                            dolor sit amet consectetur amet consectetur adipisicing elit. Earum autem
                                            adipisicing elit. quaerat distinctio --<i
                                                class="ri-double-quotes-r fs-15"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <div class="">
                                        <div class="">
                                            <span class="avatar avatar-xxl mb-3">
                                                <img src="{{ url(config('common.path_template_web') . 'images/faces/1.jpg') }}"
                                                    alt="">
                                            </span>
                                        </div>
                                        <div class="lh-1 ">
    ...
    <section class="section section-background section-style" id="contact">
        <div class="container text-center">
            ...
            <p class="text-muted fs-15 mb-5 fw-normal">You can contact us anytime regarding any queries or deals,dont
                hesitate to clear your doubts before trying our product.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7 border rounded-3  p-3">
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-xl-6">
                                            <label for="contact-address-lastname" class="form-label ">Last Name
                                                :</label>
                                        ...
                                        <div class="col-xl-6 mt-4">
                                            ...
                                            <input type="email" class="form-control" id="contact-address-email1"
                                                placeholder="Enter Email Id">
                                        </div>
                                        <div class="col-xl-6 mt-4">
                                    ...
                                    <div class="card-footer border-top-0 ps-0 pb-0 mt-1">
                                        <div class="text-start">
                                            <button type="button" aria-label="button"
                                                class="btn btn-primary btn-wave">Send Message</button>
                                        </div>
                                    </div>
    ...
    <section class="section landing-footer text-fixed-white">
        <div class="container">
            <div class="row">
                <div class="col-xl-4">
                    <div class="px-4">
                        <p class="fw-semibold mb-3"><a aria-label="anchor" href="index.html"><img
                                    src="{{ url(config('common.path_template_web') . 'images/brand-logos/desktop-dark.png') }}"
                                    alt=""></a></p>
                        ...
                        <p class="mb-0 op-6 fw-normal">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem ea
                            esse ad</p>
                    </div>
                </div>
                <div class="col-xl-2">
