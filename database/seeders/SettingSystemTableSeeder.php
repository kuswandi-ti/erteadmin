...
class SettingSystemTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $input = [
            ['key' => 'company_name', 'value' => 'CV. Harmoni Cipta Teknologi', 'created_by' => $user],
            ['key' => 'site_title', 'value' => 'ErteAdmin', 'created_by' => $user],
            ['key' => 'company_email', 'value' => 'admin@harmonipayment.my.id', 'created_by' => $user],
            ['key' => 'company_phone', 'value' => '', 'created_by' => $user],
            ['key' => 'company_address', 'value' => 'Puri Harmoni 6, Bogor', 'created_by' => $user],
