...
<head>
    ...
    @include('web.layouts.partials.master._styles')
...
<body>
    @include('web.layouts.partials.master._switcher')
    ...
    <div class="page">
        @include('web.layouts.partials.master._header')

        @include('web.layouts.partials.master._sidebar')
    ...
    @include('web.layouts.partials.master._scripts')
