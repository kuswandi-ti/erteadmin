        ...
        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <form method="POST" action="{{ route('customervisit.store') }}" class="f1">
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        @can('customer visit backdate')
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="tgl_visit" class="form-label text-default">{{ __('Tanggal Visit') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-text text-muted">
                                            <i class="ri-calendar-line"></i>
                                        </div>
                                        <input type="text"
                                            class="form-control flatpickr @error('tgl_visit') is-invalid @enderror"
                                            name="tgl_visit" value="{{ formatDate(date('Y/m/d')) }}"
                                            placeholder="{{ __('Tanggal Visit') }}" required>
                                        @error('tgl_visit')
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="toko" class="form-label text-default">{{ __('Toko') }}</label>
                                    <select class="js-example-placeholder-single js-states form-control select2" name="toko"
                                        id="toko">
                                        <option value="">{{ __('Pilih Toko...') }}</option>
                                        @foreach ($store as $data)
                                            <option value="{{ $data->id }}"
                                                {{ old('toko') == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="sales" class="form-label text-default">{{ __('Sales') }}</label>
                                    <select class="js-example-placeholder-single js-states form-control select2" name="sales"
                                        id="sales">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="mb-2 form-check-lg form-switch">
                                                            <input class="form-check-input form-checked-danger"
                                                                value="Others" type="checkbox" role="switch"
                                                                name="param_lihat[]" id="chk-lihat-others">
                                                            <label class="form-check-label"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="mb-3 form-check-lg form-switch">
                                                            <input class="form-check-input form-checked-danger"
                                                                value="Promo" type="checkbox" role="switch"
                                                                name="param_tanya[]" id="chk-tanya-promo">
                                                            <label class="form-check-label"
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="mb-3 form-check-lg form-switch">
                                                            <input class="form-check-input form-checked-danger"
                                                                value="Barang" type="checkbox" role="switch"
                                                                name="param_tanya[]" id="chk-tanya-barang">
                                                            <label class="form-check-label"
                                                                for="chk-tanya-barang">{{ __('Barang') }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="mb-4 col-sm-8" id="div-tanya-brand"
                                                        style="display: none">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="mb-3 form-check-lg form-switch">
                                                            <input class="form-check-input form-checked-danger"
                                                                value="Others" type="checkbox" role="switch"
                                                                name="param_tanya[]" id="chk-tanya-others">
                                                            <label class="form-check-label"
                                                                for="chk-tanya-others">{{ __('Others') }}</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8 mb-3" id="div-tanya-others"
                                                        style="display: none">
                                                        <input type="text"
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-4 col-sm-8" id="div-coba-goldmart"
                                                        style="display: none">
                                                        <div class="table-responsive mb-2">
                                                            <table width="100%">
                                                                <thead>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-4 col-sm-8" id="div-beli-goldmart"
                                                        style="display: none">
                                                        <div class="table-responsive mb-2">
                                                            <table>
                                                                <thead>
...
@push('scripts')
    <script>
        $('body').on('change', '#toko', function() {
            var id_toko = this.value;

            $("#sales").html('');

            $.ajax({
                url: "{{ route('customervisit.get_sales') }}",
                type: "POST",
                data: {
                    id_toko: id_toko,
                    _token: '{{ csrf_token() }}'
                ...
                success: function(result) {
                    ...
                    $.each(result.sales, function(key, value) {
                        $("#sales").append('<option value="' + value.id + '">' + value
                            .nama +
                            '</option>');
                    });
                }
