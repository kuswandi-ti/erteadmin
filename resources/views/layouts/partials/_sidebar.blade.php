        ...
        <div class="sidenav-wrapper">
            ...
            <div class="sidenav-profile bg-gradient">
                ...
                <div class="user-profile">
                    {{-- <img src="{{ !empty(getLoggedUser()->image) ? url(config('common.path_storage') . getLoggedUser()->image) : url(config('common.path_template') . config('common.image_square_200x200')) }}"
                        alt=""> --}}
                    <img src="{{ !empty(auth()->user()->image) ? url(config('common.path_storage') . auth()->user()->image) : url(config('common.path_template') . config('common.image_square_200x200')) }}"
                        alt="">
                </div>
            ...
            <ul class="sidenav-nav ps-0">
                ...
                <li>
                    <a href="#" class="logout"><i class="bi bi-box-arrow-right"></i> {{ __('Logout') }}</a>
