    ...
    <div class="main-header-container container-fluid">
        ...
        <div class="header-content-right">
            ...
            <div class="header-element">
                ...
                <a aria-label="anchor" href="#" class="header-link logout">
                    <!-- Start::header-link-icon -->
                    <i class="bx bx-log-out header-link-icon ionicon"></i>
            ...
            <div class="header-element mainuserProfile">
                        ...
                        <div class="d-sm-flex wd-100p">
                            <div class="avatar avatar-sm">
                                <img alt="avatar" class="rounded-circle"
                                    src="{{ !empty(getLoggedUser()->image) ? url(config('common.path_storage') . getLoggedUser()->image) : url(config('common.path_template') . config('common.image_default_user_profile_small')) }}"
                                    width="28" height="28">
                            </div>
                            <div class="my-auto ms-2 d-none d-xl-flex">
                                <h6 class="mb-0 font-weight-semibold fs-13 user-name d-sm-block d-none">
                                    {{ getLoggedUser()->name }}</h6>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <ul class="overflow-hidden border-0 dropdown-menu main-header-dropdown header-profile-dropdown"
                    ...
                    <li>
                        ...
                        <form
                            action="{{ getGuardNameLoggedUser() == 'member' ? route('member.logout') : route('admin.logout') }}"
