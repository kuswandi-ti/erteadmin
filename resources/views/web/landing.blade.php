...
<head>
    @include('web.layouts.partials.landing._meta')

    <title>{{ $setting_system['site_title'] ?? config('app.name') }} &mdash; @yield('page_title')</title>

    @include('web.layouts.partials.landing._favicon')

    @stack('link_vendor')

    @include('web.layouts.partials.landing._styles')
...
<body class="landing-body">
    ...
    <div class="landing-page-wrapper">
        ...
        <div class="main-content landing-main">
            ...
            @include('web.layouts.partials.landing._footer')
    ...
    @include('web.layouts.partials.landing._scripts')
